...
import com.divisosoft.trafficpatrol.service.mapper.AppUserMapper;
...
class AppUserResourceIT {
    ...
    private static final String DEFAULT_PHONE_NUMBER = "3606170127";
    private static final String UPDATED_PHONE_NUMBER = "5637587649";
    ...
    public static AppUser createEntity(EntityManager em) {
        AppUser appUser = new AppUser().phoneNumber(DEFAULT_PHONE_NUMBER).address(DEFAULT_ADDRESS).pinCode(DEFAULT_PIN_CODE);
        return appUser;
    }
    ...
    public static AppUser createUpdatedEntity(EntityManager em) {
        AppUser appUser = new AppUser().phoneNumber(UPDATED_PHONE_NUMBER).address(UPDATED_ADDRESS).pinCode(UPDATED_PIN_CODE);
        return appUser;
    }
    ...
    void createAppUser() throws Exception {
        ...
        assertThat(testAppUser.getPinCode()).isEqualTo(DEFAULT_PIN_CODE);
    }
    ...
    void putExistingAppUser() throws Exception {
        ...
        updatedAppUser.phoneNumber(UPDATED_PHONE_NUMBER).address(UPDATED_ADDRESS).pinCode(UPDATED_PIN_CODE);
        ...
        assertThat(testAppUser.getPinCode()).isEqualTo(UPDATED_PIN_CODE);
    }
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.pinCode(UPDATED_PIN_CODE);
    ...
    void fullUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.phoneNumber(UPDATED_PHONE_NUMBER).address(UPDATED_ADDRESS).pinCode(UPDATED_PIN_CODE);
