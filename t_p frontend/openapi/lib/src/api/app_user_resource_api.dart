...
class AppUserResourceApi {
  ...
  /// Returns a [Future] containing a [Response] with a [AppUserDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppUserDTO>> getAppUserByUserID({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/app-users/userid/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
